 ...
 * Batch 5, Batch 6, Batch 7 and Batch 8 extend this proven layer without replacing the V4 editor engine.
 */
public class Batch4PersistenceActivity extends Batch8FeatureActivity {
